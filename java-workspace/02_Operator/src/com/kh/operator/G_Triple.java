...
public class G_Triple {
	/*
	 * 삼항 연산자 : 피 연산자 3개 => 값 3개의 1개의 연산자로 이루어짐(조건문의 형식으로 쓰임)
	 * 
	 * 
	 * 조건문 : 값에 따라 연산을 처리하는 방식
	 * 		   결과값이 true 일 경우 첫 번째 문장을 처리 ~~~
	 * 		   결과값이 false 일 경우 두 번째 문장을 처리 ~~~
	 * 
	 * [표현식]
	 * 조건식? 조건식이 true 일 경우 결과값 : 조건식이 false 일 경우 결과값
	 * 
	 */
...
//							: "1번 아닌거 시킴";
		...
		System.out.println(selectedMenu); // stack 에서 out
	...
	public void method2() {
		...
		// 정수형 변수 공간에 초기화
		int num = sc.nextInt();
		//System.out.println("변수값 찍어보기 > " + num);
		
		
		// num % 2 != 0
		// num % 2 == 1
		// num % 2 == 0 ==> 연산 (판별)은 요걸로 하기로 결정
	...
	public void practice() {
		...
		String result = (65 <= letter) || (letter <= 90) ? "대문자" : "소문자";
		
		System.out.println("이 알파벳 " + letter + "은(는) "+ result + "입니다.");
